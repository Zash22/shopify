...
@section('content')
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
            <div class="panel-heading">Carrier Preferences</div>
            <div class="panel-body">

                {!! Form::model($preference, ['route'=>['preference.update', $preference->shop], 'method' => 'PUT',
                'class'=>'form-horizontal']) !!}

                {{ Form::hidden('shop', $preference->shop, array('id' => 'shop')) }}
                ...
                <div class="row col-md-12">
                    ...
                    <div class="panel panel-default col-md-5">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group ">
                                {!! Form::label('display_1', 'Display Overnight Before 10:00 as', ['class'=>'col-md-3 control-label']) !!}
                                <div class="col-md-6">
                                    {!! Form::text('display_1', null, ['class'=>'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                {!! Form::label('markup_1', 'Markup %', ['class'=>'col-md-3 control-label']) !!}
                                <div class="col-md-6">
